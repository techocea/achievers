...
export const ServiceData = [
  {
    ...
    icon:FaUniversity,
    description:"Our skilled counselors will guide you through the university admission process, applying on your behalf and securing the offer letter. We'll assist with fee payment and provide the necessary visa application documentation once you receive the offer letter."
  },
  {
    id:2,
    heading:"Visa Assistance",
    icon:FaPassport,
    description:"Our visa officers will guide you through the application process step by step. Receive a checklist, prepare your documents, and upon completion, we'll apply for your visa."
  },
  {
    id:3,
    heading:"Pre Departure Assistance",
    icon:BiSolidPlane,
    description:"After realizing your dream, we ensure a seamless transition with final document checks, airport transport, and assistance with air tickets."
  },
   {
    id:4,
    heading:"Air Tickets",
    icon:MdOutlineAirplaneTicket,
    description:"We can assist you in purchasing air tickets to your desired destination at special rates through reputable travel agents. Get the best price with us!"
  },
  {
    id:5,
    heading:"Vehicle Financing",
    icon:FaCarSide,
    description:"Overseas student? Getting a bank loan for your vehicle might seem impossible, but don't worry – we've got you covered. We can make arrangements to secure the funds you need. Let's make your vehicle dreams a reality!"
  },
  {
    id:6,
    heading:"Accommodation",
    icon:ImHome,
    description:"At Negombo Smart Achievers, we simplify your move to a new country. Once your visa is approved, our dedicated team will assist you in finding accommodation for a smooth and hassle-free transition."
  },
]