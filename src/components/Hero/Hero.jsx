          ...
          <div className="absolute bottom-0 lg:left-1/2 transform lg:-translate-x-1/2 flex lg:justify-center justify-evenly items-center">
            ...
            <div className="w-[630px]">
              <div className="relative">
                ...
                <div className="absolute top-16 left-40 bg-white w-auto p-1 h-auto rounded-lg shadow-lg text-[#1F0259]">
                ...
                <div className="absolute top-36 right-16 bg-white w-auto p-1 h-auto rounded-lg shadow-lg text-[#1F0259]">
                  <p className="font-medium">
                    <strong>50%</strong>
                    <br />
                    Student Loan
