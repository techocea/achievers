    ...
    <>
      <div className="w-full h-[500px] relative max-md:w-full">
        ...
        <div className="absolute left-1/2 top-1/2 transform -translate-y-1/2 -translate-x-1/2 max-md:bottom-6 items-center flex flex-col max-md:p-5">
          ...
          <p className="text-white font-medium text-lg">Our extensive experience in the international education industry makes following your dream of international education a simpler and easier process.</p>
          </div>
        </div>
      </div>
      <div className="">
      ...
      <h1 className="text-[16px] pl-10 lg:pl-52 font-bold mb-2">WHY US</h1>
        ...
        >
          ...
          <div className=" bg-slate-100/100 p-10 lg:px-52 flex flex-row-reverse lg:justify-center items-center gap-20 w-full">
            <p className="text-[16px] lg:text-[20px] w-1/2">
