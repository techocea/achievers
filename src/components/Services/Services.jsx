      ...
      <main className="bg-slate-200 m-0">
        <section className="p-10 lg:p-20 max-md:p-12 flex flex-col gap-10 lg:gap-20 ">
         <div className="text-center items-center justify-center">
           <h1 className="text-[16px] text-[#000080] uppercase font-bold mb-2.5">our services</h1> 
            <p className="text-slate-600 font-semibold">guiding you through visa applications, accommodation, and settling into a new educational journey seamlessly</p>
         </div>
          <div className="grid grid-cols-2 lg:grid-cols-3 max-md:grid-cols-1 max-md:gap-20 gap-8 lg:gap-10 items-center justify-center">
            {ServiceData.map((item)=>{
             ...
             <span className="flex items-center justify-center w-20 h-20 rounded-full bg-green-400/30">
              {React.createElement(item.icon, { className: "text-green-500", size:40 })}</span>
